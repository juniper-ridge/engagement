...
export default async function ProtectedAdminLayout({
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      {/* Sidebar */}
      <aside className="w-64 bg-[#1a2316] text-white flex flex-col min-h-screen shrink-0">
        <div className="px-6 py-8 border-b border-white/10">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-full bg-[#2d5a27] flex items-center justify-center font-bold text-sm">
              JR
            </div>
            <div>
              <div className="font-[family-name:var(--font-playfair)] font-bold text-sm">
                Juniper Ridge
              </div>
        ...
        <div className="px-4 py-6 border-t border-white/10">
          <div className="flex items-center gap-3 px-3 py-2 rounded-lg">
            <div className="w-8 h-8 rounded-full bg-[#2d5a27] flex items-center justify-center text-xs font-bold uppercase">
